...
export function makeServer({ environment = "development" } = {}) {
  let server = createServer({
    ...
    seeds(server) {
      ...
      server.create('lecture', { title: "Lecture 1: Introduction", video_url: 'https://www.youtube.com/embed/Wy9q22isx3U', course: project_one, isDeleted: false })
      server.create('lecture', { title: "Lecture 2: Vue Basics", video_url: 'https://www.youtube.com/embed/Wy9q22isx3U', course: project_one, isDeleted: false })
